...
foreign import javascript unsafe "h$ghcjsbn_sizeInBase_b($1)" js_sizeInBaseBigNat :: ByteArray# -> Int# -> Word#
#else
...
foreign import javascript unsafe "h$ghcjsb_exportToAddr_w($1,$2_1,$2_2,$3)" js_exportWordToAddr :: Word# -> Addr# -> Int# -> IO Word
#else
...
foreign import javascript unsafe "h$ghcjs_exportToMutableByteArray_b($1,$2,$3,$4)" js_exportBigNatToMutableByteArray :: ByteArray# -> MutableByteArray# RealWorld -> Word# -> Int# -> IO Word
#else
...
foreign import javascript unsafe "h$ghcjs_exportToMutableByteArray_w($1,$2,$3,$4)" js_exportWordToMutableByteArray :: Word# -> MutableByteArray# RealWorld -> Word# -> Int# -> IO Word
#else
...
foreign import javascript unsafe "h$ghcjbn_testPrime_b($1,$2)" js_testPrimeBigNat :: ByteArray# -> Int# -> Int#
#else
